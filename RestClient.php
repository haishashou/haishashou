 ...
 *这个REST客户端的优点：
 *1.支持简单认证
 *2.支持GET，PUT，POST，DELETE方法，该方法可以在PHP中通过$_SERVER['REQUEST_METHOD']获取，这点非常好！
 *3.使用方便，支持获取返回的状态码、主体、内容类型等。

 *它的缺点：
 *1.不支持自定义header

 *项目地址：https://code.google.com/p/gisgraphy/source/browse/trunk/gisgraphy/src/main/php/client/restclient.php 
 */
class RestClient {
      ...
      * @return sign
      */
     public static function signate($para,$key){
